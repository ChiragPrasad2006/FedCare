...
echo "  kubectl port-forward -n fedcare svc/hospital-server-1 5001:5001"
echo "  kubectl port-forward -n fedcare svc/hospital-server-2 5002:5001"
echo ""
echo "View logs:"
echo "  kubectl logs -n fedcare deployment/main-server"
echo "  kubectl logs -n fedcare deployment/hospital-server-1"
echo ""
